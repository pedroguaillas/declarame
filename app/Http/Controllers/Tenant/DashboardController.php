...
class DashboardController extends Controller
{
    public function __invoke(): Response
    {
        ...
        return Inertia::render('Dashboard', [
            'month' => $this->periodStats($companyId, $now->copy()->startOfMonth(), $now),
            'year' => $this->periodStats($companyId, $now->copy()->startOfYear(), $now),
            'trend' => $this->monthlyTrend($companyId),
            'topProviders' => $this->topProviders($companyId, $now->copy()->startOfYear(), $now),
        ]);
    }
