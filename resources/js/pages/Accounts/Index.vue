...
import { importMethod } from '@/actions/App/Http/Controllers/Tenant/AccountController';
  ...
  <AdminLayout>
    ...
    >
      ...
      <p class="text-muted-foreground mb-6 text-sm">
        Importa el plan de cuentas desde un archivo Excel (.xlsx)
      </p>
      <button
        type="button"
    ...
    >
      <table class="divide-border min-w-full divide-y">
        ...
        <tbody class="divide-border bg-card divide-y">
          ...
          >
            <td
              class="text-foreground px-5 py-2.5 font-mono text-sm whitespace-nowrap"
            >
              {{ account.code }}
            </td>
